...
public class Manage_Parcel_Intra_Controller {
    ...
    public void populateLists() {
        ...
        ResultSet rs1 = databaseOP.ManagerOP.getIntracityDriversForManager(Session.getInstance().getManagerID());
        ResultSet rs2 = databaseOP.ManagerOP.getIntracityParcelsForManager(Session.getInstance().getManagerID());
